...
<head>
  ...
  <title>Akreditasi | Edit Akreditasi LAM Teknik</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Edit Akreditasi LAM Teknik</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Edit Akreditasi LAM Teknik</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="keterangan" class="form-control" id="exampleInputKeterangan1"
                          ><?php echo $row[3]; ?></textarea>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputTindakLanjut1">Tindak Lanjut:</label>
                          <textarea type="text" name="tindak_lanjut" class="form-control" id="exampleInputTindakLanjut1">
