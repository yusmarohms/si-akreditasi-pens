...
<head>
  ...
  <title>Akreditasi | Add Tim Akreditasi</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Add Tim Akreditasi</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new Tim Akreditasi</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  <!-- jquery validation -->
                  <!-- form start -->
                  <form id="quickForm" action="proses_add.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                    <div class="row">
                      <div class="col">
    ...
    $(function () {
      $('#quickForm').validate({
        ...
        messages: {
          ...
          gelar_dpn: {
            required: "Please enter a gelar depan"
          },
          gelar_blk: {
            required: "Please enter a nip"
          },
          ...
          golawal: {
            required: "Please enter a golongan awal"
          },
          golakhir: {
            required: "Please enter a golongan akhir"
          },
          id_fungsional: {
            required: "Please enter a jabatan fungsional"
          },
          id_statuskaryawan: {
