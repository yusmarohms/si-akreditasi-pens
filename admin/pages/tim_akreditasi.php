...
<head>
  ...
  <title>SI Akreditasi | Tim Akreditasi</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Tim Akreditasi</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index3.php">Home</a></li>
              <li class="breadcrumb-item active">Data Tim Akreditasi</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"><b>Tim Akreditasi</b></h3>
            <a href="tim_akreditasi/add.php">
          ...
          <div class="card-body">
            <table id="tim" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>NIP</th>
                  <th>Username</th>
              ...
              <?php
                include 'koneksi.php';
                $stid = oci_parse($koneksi, 'SELECT * from tim_akreditasi
              ...
              <tr>
                ...
                <td><a href="#" data-toggle="popover"  
                      data-content="<?php echo $data[4]; ?>">
                      view
                    </a>
                </td>
                <td class="td-actions">
                  <div class="btn-group-sm" role="group" aria-label="Basic example">
                  <a href="tim_akreditasi/edit.php?id=<?= $data[0] ?>">
                      <button type="button" class="btn-sm btn-success">
                        <i class="nav-icon fas fa-pen"></i>
                      </button>
                    </a>
                    <a href="tim_akreditasi/delete.php?id=<?= $data[0] ?>" 
