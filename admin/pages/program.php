...
<head>
  ...
  <title>SI Akreditasi | Program</title>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"><b>Program</b></h3>
          </div>
          <div class="card-body">
            <table id="program" class="table table-bordered table-striped border border-secondary">
              ...
              <?php
                include 'koneksi.php';
                $stid = oci_parse($koneksi, 'SELECT * from program');
                oci_execute($stid);
        ...
        <div class="card">
          <!-- /.card-header -->
          <div class="card-header">
            <h3 class="card-title"><b>Jurusan</b></h3>
          </div>
          <div class="card-body">
            <table id="jurusan" class="table table-bordered table-striped border border-secondary">
              <thead class="bg-secondary">
              <tr>
                <th>#</th>
                <th>Nama Jurusan</th>
              ...
              <?php
                include 'koneksi.php';
                $sql = oci_parse($koneksi, 'SELECT * from jurusan');
                oci_execute($sql);
        ...
        <div class="card">
          <!-- /.card-header -->
          <div class="card-header">
            <h3 class="card-title"><b>Departemen</b></h3>
          </div>
          <div class="card-body">
            <table id="departemen" class="table table-bordered table-striped border border-secondary">
              <thead class="bg-secondary">
              <tr>
                <th>#</th>
              ...
              <tbody>
                <?php
                  include 'koneksi.php';
                  $query = oci_parse($koneksi, 'SELECT * from departemen');
                  oci_execute($query);
                  while ($list = oci_fetch_row($query)) {
                ?>
                <tr>
