...
<head>
  ...
  <title>SI Akreditasi | Data Tim Akreditasi</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="data_tim_ak.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Tim AK</p>
                </a>
              </li>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="staff" class="table table-bordered table-striped border border-secondary">
              ...
              <?php
                include 'koneksi.php';
                $stid = oci_parse($koneksi, 'SELECT * from staff');
                oci_execute($stid);
        ...
        <div class="card">
          <!-- /.card-header -->
          <div class="card-header">
            <h3 class="card-title"><b>Status Karyawan</b></h3>
          </div>
          <div class="card-body">
            <table id="karyawan" class="table table-bordered table-striped border border-secondary">
              <thead class="bg-secondary">
              <tr>
                <th>#</th>
              ...
              <tbody>
                <?php
                  include 'koneksi.php';
                  $query = oci_parse($koneksi, 'SELECT * from status_karyawan');
                  oci_execute($query);
