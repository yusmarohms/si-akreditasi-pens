...
<head>
  ...
  <title>Program Studi | Edit Prodi Teknik</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Edit Prodi Teknik</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <?php
                    ...
                    $query = "SELECT * from prodi_teknik
                    where id_teknik='$ID' ";
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_jurusan" class="custom-select" id="exampleInputJurusan1">
                          <?php
                            include('../koneksi.php');
                            $database = "SELECT * from prodi_teknik
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_departemen" class="custom-select" id="Departemen1">
                          <?php
                            include('../koneksi.php');
                            $statement = "SELECT * from prodi_teknik
                  ...
                  <?php 
                    if (isset($_POST['simpan'])) {
                      ...
                      $ubah = "UPDATE prodi_teknik SET id_teknik=$ID, id_program=$id_program, id_jurusan=$id_jurusan, 
                      id_departemen=$id_departemen WHERE id_teknik=$ID";
                        ...
                        if ($res) {
                          ...
                          window.location.href='edit_prodi_teknik.php'</script>";
                        }
                      }
                    }
                  ?>
