...
<head>
  ...
  <title>Program Studi | Edit Prodi Infokom</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../manajemen_tim_ak.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Manajemen Tim AK</p>
                  </a>
                </li>
                <li class="nav-item">
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Edit Prodi Infokom</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <?php
                    ...
                    $query = "SELECT * from prodi_infokom
                    where id_infokom='$ID' ";
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_jurusan" class="custom-select" id="exampleInputJurusan1">
                          <?php
                            include('../koneksi.php');
                            $database = "SELECT * from prodi_infokom
                            ...
                            while ($jurus = oci_fetch_row($hasil)) {
                              echo "<option value=$jurus[4]>$jurus[5]</option>";
                            }
                          ?>
                          <?php
                            include('../koneksi.php');
                            $database2 = "SELECT * FROM jurusan ORDER BY nomor ASC";
                      ...
                      <div class="form-group">
                        ...
                        <select name="id_departemen" class="custom-select" id="Departemen1">
                          <?php
                            include('../koneksi.php');
                            $statement = "SELECT * from prodi_infokom
                            inner join departemen on departemen.nomor = prodi_infokom.id_departemen
                            where id_infokom='$ID' ";
                            $stid = oci_parse($koneksi, $statement);
                            oci_execute($stid);
                            while ($dep = oci_fetch_row($stid)) {
                              echo "<option value=$dep[4]>$dep[5]</option>";
                            }
                          ?>
                          <?php
                            include('../koneksi.php');
                            $statement2 = "SELECT * FROM departemen ORDER BY nomor ASC";
                            $stid2 = oci_parse($koneksi, $statement2);
                            oci_execute($stid2);
                            while ($dep2 = oci_fetch_row($stid2)) {
                              echo "<option value=$dep2[0]>$dep2[1]</option>";
                            }
                          ?>
                        </select>
                      </div>
                  ...
                  <?php 
                    if (isset($_POST['simpan'])) {
                      ...
                      $ubah = "UPDATE prodi_infokom SET id_infokom=$ID, id_program=$id_program, id_jurusan=$id_jurusan, 
                      id_departemen=$id_departemen WHERE id_infokom=$ID";
                      
                        $hasilubah = oci_parse($koneksi,$ubah);
                      
                        $r = oci_execute($hasilubah, OCI_DEFAULT) or die("execute error");
                        ...
                        if ($res) {
                          ...
                          window.location.href='../program_studi.php'</script>";
                        } else {
                          // pesan jika data gagal disimpan
                          echo "<script>alert('Data gagal diupdate');
                          window.location.href='edit_prodi_infokom.php'</script>";
                        }
                      }
                    }
                  ?>
