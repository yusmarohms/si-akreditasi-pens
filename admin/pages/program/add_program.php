...
<head>
  ...
  <title>Program | Add Program</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new Program</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  <!-- jquery validation -->
                  <!-- form start -->
                  <form id="quickForm" action="proses_add_program.php" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputProgram1">Nama Program:</label>
                        <input type="text" name="program" class="form-control" id="exampleInputProgram1"
                          placeholder="Enter program">
                      </div>
                      <div class="form-group">
                        <label for="ketProgram">Keterangan Program:</label>
                        <input type="text" name="ket_program" class="form-control" id="ketProgram"
