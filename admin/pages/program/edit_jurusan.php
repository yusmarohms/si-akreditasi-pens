...
<head>
  ...
  <title>Program | Edit Jurusan</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Edit Jurusan</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  ...
                  <form id="quickForm" action="" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="jurusan" class="form-control" value="<?= $row[1]; ?>" id="InputJurusan1"
                  ...
                  if (isset($_POST['simpan'])) {
                    ...
                    $ubah = "UPDATE tb_jurusan SET id_jurusan=$ID, jurusan='$jurusan' 
                    WHERE id_jurusan=$ID";
                        ...
                        window.location.href='../program.php'</script>";
                          ...
                          window.location.href='edit_jurusan.php'</script>";
                        }
                      }
                    } 
                  ?>
