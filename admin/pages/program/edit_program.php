...
<head>
  ...
  <title>Program | Edit Program</title>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../program.php" class="nav-link active">
            ...
            <li class="nav-item">
              <a href="../file_akreditasi.php" class="nav-link">
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Edit Program</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  ...
                  <form id="quickForm" action="" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="program" class="form-control" value="<?= $row[1]; ?>" id="InputProgram1"
                          placeholder="Enter program">
                      </div>
                      <div class="form-group">
                        <label for="ketProgram">Keterangan Program:</label>
                        <input type="text" name="ket_program" class="form-control" value="<?= $row[2]; ?>"id="ketProgram"
                          placeholder="Enter keterangan program">
                      </div>
                      <div class="form-group">
                  ...
                  if (isset($_POST['simpan'])) {
                    ...
                    $ubah = "UPDATE tb_program SET id_program=$ID, program='$program', ket_program='$ket_program' 
                    WHERE id_program=$ID";
                        ...
                        window.location.href='../program.php'</script>";
                          ...
                          window.location.href='edit_program.php'</script>";
                        }
                      }
                    } 
                  ?>
    ...
    $(function () {
      $('#quickForm').validate({
        ...
        messages: {
          ...
          ket_program: {
            required: "Please enter a keterangan program"
          },
        },
        errorElement: 'span',
