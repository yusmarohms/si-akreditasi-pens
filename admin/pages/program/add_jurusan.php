...
<head>
  ...
  <title>Program | Add Jurusan</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new Jurusan</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  <!-- jquery validation -->
                  <!-- form start -->
                  <form id="quickForm" action="proses_add_jurusan.php" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="exampleInputJurusan1">Nama Jurusan:</label>
                        <input type="text" name="jurusan" class="form-control" id="exampleInputJurusan1"
