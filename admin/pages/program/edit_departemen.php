...
<head>
  ...
  <title>Program | Edit Departemen</title>
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Edit Departemen</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  ...
                  <form id="quickForm" action="" method="post">
                    <div class="card-body">
                      <div class="form-group">
                        <label for="InputDepartemen1">Nama Departemen:</label>
                        <input type="text" name="departemen" class="form-control" value="<?= $row[1]; ?>" id="InputDepertemen1"
                  ...
                  if (isset($_POST['simpan'])) {
                    ...
                    $ubah = "UPDATE tb_departemen SET id_departemen=$ID, departemen='$departemen' 
                    WHERE id_departemen=$ID";
                        ...
                        window.location.href='../program.php'</script>";
                          ...
                          window.location.href='edit_departemen.php'</script>";
                        }
                      }
                    } 
                  ?>
