...
<head>
  ...
  <title>Manajemen File | Add File Infokom</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Add File Akreditasi LAM Infokom</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <ul class="nav nav-tabs justify-content-center">
              <li class="nav-item">
                <a class="nav-link" href="add_teknik.php">File Teknik</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">File Infokom</a>
              </li>
            </ul>
            <!-- /.card-header -->
            <div class="card-header">
              <h3 class="card-title"><b>Add a new File Infokom</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  <!-- jquery validation -->
                  <!-- form start -->
                  <form id="quickForm" action="proses_add_infokom.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <option value="">--Pilih Program--</option>
                            <?php
                            include('../koneksi.php');
                            $sql = "SELECT prodi_infokom.id_program, program.program FROM program
                            INNER JOIN prodi_infokom ON prodi_infokom.id_program = program.nomor
                            GROUP BY prodi_infokom.id_program, program.program
                        ...
                        <div class="form-group">
                          ...
                          <option value="">--Pilih Jurusan--</option>
                            <?php
                            include('../koneksi.php');
                            $sql = "SELECT prodi_infokom.id_jurusan, jurusan.jurusan FROM jurusan
                            INNER JOIN prodi_infokom ON prodi_infokom.id_jurusan = jurusan.nomor
                            GROUP BY prodi_infokom.id_jurusan, jurusan.jurusan
