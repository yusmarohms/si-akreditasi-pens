...
<head>
  ...
  <title>Akreditasi | Edit Admin</title>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="username" value="<?= $row[1]; ?>" class="form-control" id="usernames"
                            placeholder="Enter username">
                        </div>
                        <div class="form-group">
                          <label for="passwords">Password:</label>
                          <input type="password" name="password" value="<?= $row[2]; ?>" class="form-control" id="passwords"
                  ...
                  <?php 
                    ...
                    $ubah = "UPDATE admin SET id_admin=$ID, username='$username', password='$password' WHERE id_admin=$ID";
