...
<head>
  ...
  <title>Akreditasi | Add Akreditasi Infokom</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Add Akreditasi LAM Infokom</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new Akreditasi LAM Infokom</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                  ...
                  <form id="quickForm" action="proses_add_infokom.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <div class="form-group">
                          <label for="ket">Keterangan Akreditasi:</label>
                          <input type="text" name="keterangan" class="form-control" id="ket" aria-label="readonly input example" readonly
                            placeholder="Keterangan">
                        </div>
                        <div class="form-group">
                          <label for="tin">Tindak Lanjut:</label>
                          <input type="text" name="tindak_lanjut" class="form-control" id="tin" aria-label="readonly input example" readonly
                            placeholder="Tindak lanjut">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputNoSK1">Nomor Surat Keputusan (SK):</label>
                          <input type="text" name="no_sk" class="form-control" id="exampleInputNoSK1"
