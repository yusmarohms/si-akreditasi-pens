...
<head>
  ...
  <title>Akreditasi | Add Akreditasi Teknik</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Add Akreditasi LAM Teknik</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new Akreditasi LAM Teknik</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
