      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"><b>Data SPM</b></h3>
            <a href="spm/add.php">
          ...
          <div class="card-body">
            <table id="spm" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>NIP</th>
                  <th>Username</th>
              ...
              <?php
                include 'koneksi.php';
                $stid = oci_parse($koneksi, 'SELECT * from spm
              ...
              <tr>
                ...
                <td><a href="#" data-toggle="popover"  
                      data-content="<?php echo $data[6]; ?>">
                      view
                    </a>
                </td>
                <td class="td-actions">
                  <div class="btn-group-sm" role="group" aria-label="Basic example">
                  <a href="spm/edit.php?id=<?= $data[0] ?>">
                      <button type="button" class="btn-sm btn-success">
                        <i class="nav-icon fas fa-pen"></i>
                      </button>
                    </a>
                    <a href="spm/delete.php?id=<?= $data[0] ?>" 
