      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="pages/program.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="pages/program_studi.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/tim_akreditasi.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tim Akreditasi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/data_tim_ak.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Data Tim AK</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/spm.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>SPM</p>
                  </a>
                </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-7">
              ...
              <div class="card-body">
                <div id="donut-chart" style="min-height: 100px; height: 385px; max-height: 400px; width: 700px; max-width: 100%;"></div>
                <br>
