...
<head>
  ...
  <title>Akreditasi | Edit Akreditasi</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Edit Akreditasi</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Edit Akreditasi</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                      ...
                      <div class="col">
                        <div class="form-group">
                          ...
                          <input type="text" name="keterangan" value="<?= $row[3]; ?>" class="form-control" id="exampleInputKeterangan1"
                            placeholder="Enter keterangan" readonly>
                        </div>
                        <div class="form-group">
                          ...
                          <input type="text" name="tindak_lanjut" value="<?= $row[4]; ?>" class="form-control" id="exampleInputTindakLanjut1"
                            placeholder="Enter tindak lanjut" readonly>
                        </div>
                        <div class="form-group">
