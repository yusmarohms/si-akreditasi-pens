      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <div class="user-panel mt-1 d-flex">
            <div class="info">
              <a href="#" class="d-block"><?php echo $_SESSION['namatim'] ?></a>
            </div>
            <div class="image">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-8">
              ...
              <br>
              <div class="card-body">
                <div id="donut-chart" style="min-height: 300px; height: 300px; max-height: 300px; width: 700px; max-width: 100%;margin-bottom: 30px;"></div>
              </div>
              <br>
                  ...
                  <div class="col">
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        INNER JOIN tim_akreditasi ON tim_akreditasi.id_program = akreditasi.id_program 
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='Unggul' AND tim_akreditasi.username='".$_SESSION['namatim']."' ");
                        oci_execute($count1);
                      ...
                      <span class="float-right"><b><?php echo $data1[0];?></b>
                        <?php
                          include 'pages/koneksi.php';
                          $count2 = oci_parse($koneksi, "SELECT COUNT (username) from tim_akreditasi
                          where username='".$_SESSION['namatim']."' ");
                          oci_execute($count2);
                    ...
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='Baik Sekali' AND tim_akreditasi.username='".$_SESSION['namatim']."' ");
                        oci_execute($count1);
                        while ( $data1 = oci_fetch_row($count1) ) {
                      ?>
                      <span class="float-right"><b><?php echo $data1[0];?></b>
                    ...
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='Baik' AND tim_akreditasi.username='".$_SESSION['namatim']."' ");
                        oci_execute($count1);
                        while ( $data1 = oci_fetch_row($count1) ) {
                      ?>
                      <span class="float-right"><b><?php echo $data1[0];?></b>
                    ...
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='A' AND tim_akreditasi.username='".$_SESSION['namatim']."' ");
                        oci_execute($count1);
                        while ( $data1 = oci_fetch_row($count1) ) {
                      ?>
                      <span class="float-right"><b><?php echo $data1[0];?></b>
                    ...
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='B' AND tim_akreditasi.username='".$_SESSION['namatim']."' ");
                        oci_execute($count1);
                        while ( $data1 = oci_fetch_row($count1) ) {
                      ?>
                      <span class="float-right"><b><?php echo $data1[0];?></b>
                    ...
                    <div class="progress-group">
                      ...
                      <?php
                        ...
                        AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                        INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                        where peringkat.akreditasi='C' AND tim_akreditasi.username='".$_SESSION['namatim']."' 
                        ");
                        oci_execute($count1);
                        while ( $data1 = oci_fetch_row($count1) ) {
                      ?>
                      ...
                      <div class="progress-group">
                        ...
                        <?php
                          ...
                          AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
                          INNER JOIN peringkat ON peringkat.id_peringkat = akreditasi.id_peringkat
                          where peringkat.akreditasi='MINIMUM' AND tim_akreditasi.username='".$_SESSION['namatim']."'");
                          oci_execute($count1);
                          while ( $data1 = oci_fetch_row($count1) ) {
                        ?>
                        <span class="float-right"><b><?php echo $data1[0];?></b>
