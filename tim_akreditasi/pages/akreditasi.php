      ...
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <h3 class="card-title"><b>Akreditasi Program Studi</b></h3>
          </div>
          <div class="card-body">
            <table id="akreditasi" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Program</th>
                  <th>Jurusan</th>
              ...
              <?php
                ...
                INNER JOIN tim_akreditasi ON tim_akreditasi.id_program = akreditasi.id_program AND tim_akreditasi.id_jurusan = akreditasi.id_jurusan
              ...
              ?>
                ...
                <td class="td-actions">
                  ...
                  <a href="akreditasi/edit_akreditasi.php?id=<?= $data[0] ?>">
