...
<head>
  ...
  <title>Manajemen File | Add File Teknik</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Add File Akreditasi LAM Teknik</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="card-title"><b>Add a new File Teknik</b></h3>
            </div>
            <div class="card-body">
              <div class="row">
                <!-- left column -->
                      ...
                      <div class="col">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="dosen" class="form-control" id="dosenn"
                            placeholder="Enter link file data dosen">
                        </div>
                        <div class="form-group">
