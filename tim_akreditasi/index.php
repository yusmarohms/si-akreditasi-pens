<html>
  ...
  <body class="hold-transition login-page">
    ...
    <div class="card-body">
      <p class="login-box-msg">Login untuk masuk sebagai <b>Tim Akreditasi</b></p>
      <form id="quickForm" method="post" action="proses_log.php" >
        <!-- <div class="form-group mb-3">
          <select class="custom-select" aria-label=".form-select-sm example">
            <option selected>Login Sebagai Tim Akreditasi</option>
            <a href="../admin/index.php"><option>Login Sebagai Admin</option></a>
            <a href="../user/index.php"><option>Login Sebagai User</option></a>
          </select>
        </div> -->
        <div class="form-group mb-3">
